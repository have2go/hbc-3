    ...
    return (
            ...
            <header className="flex justify-between items-center gap-3 LG:hidden">
                <div className="flex flex-col w-64 text-white">
                    <div className="flex gap-1 text-sm">
                        <Link href="/" className="hover:text-customYellow transition-all">
                            RU
                        </Link>
                        <p>—</p>
                ...
                <div className="flex text-white text-base font-bold text-nowrap 2XL:text-sm ">
                    <Link
                        ...
                        className={`px-[5px] border-r ${
                            pathname === "/en/payment-agent" ? "text-customYellow" : "text-white"
                        } hover:text-customYellow transition-all`}
                    >
                        Payment agent
                    </Link>
                    <Link
                        href="/en/customs-clearance"
                        className={`px-[5px] border-r ${
                            pathname === "/en/customs-clearance" ? "text-customYellow" : "text-white"
                        } hover:text-customYellow transition-all`}
                    >
                        Customs clearance
                    </Link>
                    ...
                    <Link
                        href="/en/contacts"
                        className={`px-[5px] ${
                            pathname === "/en/contacts" ? "text-customYellow" : "text-white"
                        } hover:text-customYellow transition-all`}
                    >
                        Contacts
                    </Link>
        ...
        <div className="flex justify-between">
          <div className="flex flex-col w-64 XL:w-56 text-white">
            ...
            <p className="text-xs pt-4 XL:text-[11px]">
          ...
          <div className="flex items-center text-white text-base font-bold text-nowrap 2XL:text-sm ">
            <Link
              href="/en/payment-agent"
              className="px-[5px] XL:px-[3px] border-r"
            >
              Payment agent
            </Link>
            <Link
              href="/en/in-development"
              className="px-[5px] XL:px-[3px] border-r"
            >
              Import
            </Link>
