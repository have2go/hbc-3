    ...
    return (
        <section className="py-[10px] my-20 LG:mt-10 MD:py-1 MD:px-7 XSM:px-4 SM:mt-0 SM:mb-6">
            <form
                ...
                ref={form}
            >
                <h2 className="text-4xl 1.5XL:text-3xl MD:text-2xl SM:text-lg">Оставить заявку или задать вопрос</h2>
                <p className="mt-5 mb-10 text-[#5E5E62] LG:text-sm 1.5XL:mt-4 1.5XL:mb-6 MD:text-xs SM:mt-2 SM:mb-4 SM:text-[11px]">
                    Для получения дополнительной информации и консультации по вопросам таможенного оформления, заполните
