...
export default function ConsultFormEn() {
    ...
    return (
        <section className="pt-20 LG:pt-10 px-10 MD:px-7 XSM:px-4">
            <form
                ...
                ref={form}
            >
                <h2 className="text-4xl LG:text-3xl MD:text-2xl SM:text-lg">Consultation with an expert</h2>
                <p className="mt-5 mb-10 text-[#5E5E62] LG:text-sm MD:mt-4 MD:mb-6 MD:text-xs SM:mt-2 SM:mb-4 SM:text-[11px]">
                    Feel free to reach out to us for a personalized offer or additional information about our services.
                </p>
